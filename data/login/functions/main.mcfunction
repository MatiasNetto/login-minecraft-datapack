...
# enable help
execute as @a[scores={IsOfline=1..}] run scoreboard players reset @s help
execute as @a[scores={IsOfline=0}] run scoreboard players enable @s help
...
# Help menu
execute as @a[scores={help=1..}] run function login:help
